...
contract AssetMart is ERC721URIStorage {
    ...
    //Check buyer sent sufficient ETH price
    //Ensure NFT is still listed for sale
    //Reject if buyer and seller are same
    //Transfer NFT to buyer's address
    //Send sale proceeds to seller
    //Update state to mark NFT as sold
